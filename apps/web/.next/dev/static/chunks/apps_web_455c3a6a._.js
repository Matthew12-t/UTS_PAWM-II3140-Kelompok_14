...
"[project]/apps/web/components/audio/background-music.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BackgroundMusic() {
    _s();
    const audioRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_babel$2d$plugin$2d$re_f3aa0ef20050acebca21685a51e97cbb$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_babel$2d$plugin$2d$re_f3aa0ef20050acebca21685a51e97cbb$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BackgroundMusic.useEffect": ()=>{
            ...
            audio.volume = 0.3;
            const handleEnded = {
                "BackgroundMusic.useEffect.handleEnded": ()=>{
                    audio.currentTime = 0;
                    audio.play();
                }
            }["BackgroundMusic.useEffect.handleEnded"];
            const handlePlay = {
                "BackgroundMusic.useEffect.handlePlay": ()=>{
                    setIsPlaying(true);
                }
            }["BackgroundMusic.useEffect.handlePlay"];
            const handlePause = {
                "BackgroundMusic.useEffect.handlePause": ()=>{
                    setIsPlaying(false);
                }
            }["BackgroundMusic.useEffect.handlePause"];
            ...
            const playAudio = {
                "BackgroundMusic.useEffect.playAudio": ()=>{
                    audio.play().catch({
                        "BackgroundMusic.useEffect.playAudio": (error)=>{
...
_s(BackgroundMusic, "3++Vb3Vwpowh6qK3Q3hZPpYayUI=");
_c = BackgroundMusic;
var _c;
...
//# sourceMappingURL=apps_web_455c3a6a._.js.map